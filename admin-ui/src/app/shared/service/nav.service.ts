...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{ path: '/products/varient', title: 'Varient', type: 'link' },
		{ path: '/products/varient-list', title: 'Varient-list', type: 'link' },
		{ path: '/products/add-category', title: 'category', type: 'link' },
		// {path : '/products/varient/:varientId'}
				// {
